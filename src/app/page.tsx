  ...
  return (
    <div className="grid grid-rows-[auto_1fr_auto] h-screen">
      <header className="bg-red-50 flex items-center h-20 shadow px-6">
        <button 
          className="md:hidden font-roboto rounded-xl px-4 py-2 bg-red-200 hover:bg-red-50 mr-4"
      ...
      <div className="flex h-full">
        <aside className={`
          fixed z-30 inset-y-0 left-0 transform shadow-md font-roboto
        ...
        `}>
          <button 
            className="md:hidden font-roboto rounded-xl px-4 py-2 bg-red-200 hover:bg-red-50"
        ...
        <main className="flex-1 flex flex-col p-8 items-center justify-center">
          <div className="text-center max-w-2xl">
            ...
            <p className="text-lg mt-4 font-roboto">
            ...
            <a
              className="font-roboto px-6 py-4 mt-4 rounded-full font-bold bg-red-50 text-gray-600 hover:text-black hover:bg-red-100 inline-block focus:outline-2 focus:outline-offset-2 focus:outline-red-100 active:bg-red-100"
              href=""
              target="_blank"
      ...
      <footer className="flex bg-red-50 shadow-inner p-4 justify-center">
        <a
          className="font-roboto text-lg hover:underline underline-offset-2"
          href=""
          target="_blank"
          rel="noopener noreferrer"
        >
